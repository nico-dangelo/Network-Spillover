...
plots=F
set.seed(1000)
system.time({res<-nsim%>%rerun(sim(N=N,eprob=eprob,phiv=phiv,PrEP1=PrEP1,PrEP2=PrEP2,p1=p1,p2=p2, model=model))})
...
#Check directory
#setwd("home/nico_dangelo_uri_edu/ondemand/data/sys/myjobs/projects/default/2/outputs")
write.table(res,file=paste0("N_",N,"phiv_",phiv,"PrEP1_",PrEP1,"PrEP2_",PrEP2,"p1_",p1,"p2_",p2,"model_",model,"nsim_",nsim,".csv"), row.names=F, sep=",")
#If summary dataframes are created, use this save line instead
#write.table(res,means, vars,file=paste0("Results","N_",N,"p1_",p1,"p2_",p2,"nsim_",".csv"), sep=",")
