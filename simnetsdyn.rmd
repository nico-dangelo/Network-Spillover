...
```{r Network Size}
params_N_dyn<-tidyr::expand_grid(N=c(20,200),phiv=0.1,PrEP1=0.1,PrEP2=0.2, p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1),model="ER",eprob=0.1,pow=1,nb=5,rprob=0.05, ReWire=F,tsteps=10,nsim=200)
...
```{r HIV Prevalence}
params_phiv_dyn<-tidyr::expand_grid(N=20,phiv=seq(0.1,1,0.1),PrEP1=PrEP1,PrEP2=PrEP2,p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1),model="ER",eprob=0.1,pow=1,nb=5,rprob=0.05, ReWire=F,tsteps=10,nsim=200)
...
```{r p1}
params_p1_dyn<-tidyr::expand_grid(N=20,phiv=0.1,PrEP1=PrEP1,PrEP2=PrEP2,p1=seq(0.1,1,0.1),p2=p2,model="ER",eprob=0.1,pow=1,nb=5,rprob=0.05, ReWire=F,tsteps=10,nsim=200)
...
```
```{r p2}
params_p2_dyn<-tidyr::expand_grid(N=20,phiv=0.1,PrEP1=PrEP1,PrEP2=PrEP2,p1=p1,p2=seq(0.1,1,0.1),model="ER",eprob=0.1,pow=1,nb=5,rprob=0.05, ReWire=F,tsteps=10,nsim=200)
