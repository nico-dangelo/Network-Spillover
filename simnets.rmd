...
h<-set_vertex_attr(g,"color",value=c(rep("red",l_hiv_h), gtools::permute(c(rep("blue",l_PrEP2_h), rep("black", l_sus_h)))))
...
ef<-prep+no_prep
names(ef)<-c("control,",paste("ran", PrEP2*100, sep=""),paste("add",((PrEP2-PrEP1)*100), sep=""),paste("regen",PrEP2*100,sep=""))
...
# }
names(cc)<-c(paste("ran", PrEP2*100, sep=""),paste("add",((PrEP2-PrEP1)*100), sep=""),paste("regen", PrEP2*100,sep=""))
...
col_list=c(paste("ran", PrEP2*100, sep=""),paste("add",((PrEP2-PrEP1)*100), sep=""),paste("regen",PrEP2*100,sep=""))
...
beepr::beep(8)
col_list_PrEP<-names(res_PrEP)[20:43]
means_PrEP<-res_PrEP%>%group_by(PrEP1,PrEP2)%>%summarise(across(col_list_PrEP,mean))
```

```{r}
PrEP_ran1<-ggplot(means_PrEP1,aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+facet_grid(~PrEP1)
PrEP_ran2<-ggplot(means_PrEP1,aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+facet_grid(~PrEP1)
PrEP_regen<-ggplot(means_PrEP1,aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+facet_grid(~PrEP1)
```
