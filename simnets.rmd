...
N_plot_1<-ggplot(means_N,aes_string(x="p1",y="p2", fill=col_list[1]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(limits=lims_means_N,colors=brewer.pal(6,name="RdYlBu"))+ xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean Contrast estimate in random PrEP allocation by network size")
N_plot_2<-ggplot(means_N,aes_string(x="p1",y="p2", fill=col_list[2]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(limits=lims_means_N,colors=brewer.pal(6,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean Contrast estimate in random additional PrEP allocation by network size")
N_plot_3<-ggplot(means_N,aes_string(x="p1",y="p2", fill=col_list[3]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(limits=lims_means_N,colors=brewer.pal(6,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean Contrast estimate in random regeneration PrEP allocation by network size")
...
N_plot_4<-ggplot(var_N,aes_string(x="p1",y="p2", fill=col_list[1]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(limits=lims_var_N,colors=brewer.pal(6,name="RdYlBu"))+ggtitle("Variance of Contrast Estimate in random PrEP allocation by network size")+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")
N_plot_5<-ggplot(var_N,aes_string(x="p1",y="p2", fill=col_list[2]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(limits=lims_var_N,colors=brewer.pal(6,name="RdYlBu"))+ggtitle("Variance of Contrast Estimate in random additional PrEP allocation by network size")+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")
N_plot_6<-ggplot(var_N,aes_string(x="p1",y="p2", fill=col_list[3]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(limits=lims_var_N,colors=brewer.pal(6,name="RdYlBu"))+ggtitle("Variance of Contrast Estimate in random regenerated PrEP allocation by network size")+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")
ggsave(plot=N_plot_5/N_plot_4/N_plot_6, file="Network Size Variance plots.png", path="Figures")
```
...
beepr::beep(8)
save(res_samp,means_samp,var_samp,file="Sample size results.RData")
```
#Mean plots
...
samp_plot_1<-ggplot(means_samp,aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+facet_grid(~nsim)+scale_fill_gradientn(limits=lims_means_samp, colors=brewer.pal(5,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random PrEP allocation by sample size")
samp_plot_2<-ggplot(means_samp,aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+facet_grid(~nsim)+scale_fill_gradientn(limits= lims_means_samp, colors=brewer.pal(5,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random additional PrEP allocation by sample size")
samp_plot_3<-ggplot(means_samp,aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+facet_grid(~nsim)+scale_fill_gradientn(limits=lims_means_samp, colors=brewer.pal(5,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random additional PrEP allocation by sample size")
```
...
```{r}
ggsave(plot=samp_plot_2/samp_plot_1/samp_plot_3, filename = "Sample size Mean plots.png", path ="Figures/")
```

variance plots
```{r}
lims_var_samp<-c(min(var_samp[,col_list]),max(var_samp[,col_list]))
samp_plot_4<-ggplot(var_samp,aes_string(x="p1",y="p2", fill=col_list[1]))+geom_tile()+facet_grid(~nsim)+scale_fill_gradientn(limits=lims_var_samp,colors=brewer.pal(6,name="RdYlBu"))+ggtitle("Variance of Contrast Estimate in random PrEP allocation by sample size")+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")
samp_plot_5<-ggplot(var_samp,aes_string(x="p1",y="p2", fill=col_list[2]))+geom_tile()+facet_grid(~nsim)+scale_fill_gradientn(limits=lims_var_samp,colors=brewer.pal(6,name="RdYlBu"))+ggtitle("Variance of Contrast Estimate in random additional PrEP allocation by sample size")+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")
samp_plot_6<-ggplot(var_samp,aes_string(x="p1",y="p2", fill=col_list[3]))+geom_tile()+facet_grid(~nsim)+scale_fill_gradientn(limits=lims_var_samp,colors=brewer.pal(6,name="RdYlBu"))+ggtitle("Variance of Contrast Estimate in random regenerated PrEP allocation by sample size")+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")
ggsave(plot=samp_plot_5/samp_plot_4/samp_plot_6, file="Sample Size Variance plots.png", path="Figures")
```
...
phiv_plot_4<-means_phiv%>%filter(phiv<0.9)%>%ggplot(aes_string(x="p1",y="p2",fill=col_list[1]))+scale_x_continuous(guide = guide_axis(n.dodge=2))+geom_tile()+facet_grid(~phiv)+scale_fill_gradientn(limits=lims_means_phiv,n.breaks=10, colors=brewer.pal(10,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random PrEP allocation by HIV prevalence")
phiv_plot_5<-means_phiv%>%filter(phiv<0.9)%>%ggplot(aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+facet_grid(~phiv)+scale_fill_gradientn(limits=lims_means_phiv,n.breaks=10,colors=brewer.pal(10,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random additional PrEP allocation by HIV prevalence")+scale_x_continuous(guide = guide_axis(n.dodge=2))
phiv_plot_6<-means_phiv%>%filter(phiv<0.9)%>%ggplot(aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+facet_grid(~phiv)+scale_fill_gradientn(limits=lims_means_phiv,n.breaks=10,colors=brewer.pal(10,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random regenerated PrEP allocation by HIV prevalence")+scale_x_continuous(guide = guide_axis(n.dodge=2))
ggarrange(phiv_plot_4/phiv_plot_5/phiv_plot_6)
ggsave(plot=phiv_plot_5/phiv_plot_4/phiv_plot_6, file="HIV Prevalence Mean plots.png", path="Figures/")
```
...
phiv_plot_7<-var_phiv%>%filter(phiv<0.9)%>%ggplot(aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+facet_grid(~phiv)+scale_fill_gradientn(limits=lims_var_phiv,n.breaks=10, colors=brewer.pal(10,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Contrast estimate Variance in random PrEP allocation by HIV prevalence")+scale_x_continuous(guide = guide_axis(n.dodge=2))
phiv_plot_8<-var_phiv%>%filter(phiv<0.9)%>%ggplot(aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+facet_grid(~phiv)+scale_fill_gradientn(limits=lims_var_phiv,n.breaks=10,colors=brewer.pal(10,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Contrast estimate Variance in random additional PrEP allocation by HIV prevalence")+scale_x_continuous(guide = guide_axis(n.dodge=2))
phiv_plot_9<-var_phiv%>%filter(phiv<0.9)%>%ggplot(aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+facet_grid(~phiv)+scale_fill_gradientn(limits=lims_var_phiv,n.breaks=10,colors=brewer.pal(10,name="RdYlBu"))+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+ggtitle("Contrast estimate Variance in random regenerated PrEP allocation by HIV prevalence")+scale_x_continuous(guide = guide_axis(n.dodge=2))
ggsave(plot=phiv_plot_8/phiv_plot_7/phiv_plot_9, file="HIV Prevalence Variance plots.png", path="Figures/")
```
...
p1_plot_1<-ggplot(means_p1,aes_string(x="p1",y=col_list[1]))+geom_point()+scale_y_continuous(limits=lims_means_p1)+xlab("P(HIV|Contact and -PrEP)")+ggtitle("Mean contrast estimate in random PrEP allocation by P(HIV|Contact and -PrEP) ")
p1_plot_2<-ggplot(means_p1,aes_string(x="p1",y=col_list[2]))+geom_point()+scale_y_continuous(limits=lims_means_p1)+xlab("P(HIV|Contact and -PrEP)")+ggtitle("Mean contrast estimate in random additional PrEP allocation by P(HIV|Contact and -PrEP) ")
p1_plot_3<-ggplot(means_p1,aes_string(x="p1",y=col_list[3]))+geom_point()+scale_y_continuous(limits=lims_means_p1)+xlab("P(HIV|Contact and -PrEP)")+ggtitle("Mean contrast estimate in random regenerated PrEP allocation by P(HIV|Contact and -PrEP) ")
```


```{r}
ggsave(plot=p1_plot_2/p1_plot_1/p1_plot_3, file="p1 Mean plots.png", path="Figures") 
# p1_plot_1
# p1_plot_2
# p1_plot_3
```
...
p1_plot_4<-ggplot(var_p1,aes_string(x="p1",y=col_list[1]))+geom_point()+scale_y_continuous(limits=lims_var_p1)+xlab("P(HIV|Contact and -PrEP)")+ggtitle("Contrast estimate variance in random PrEP allocation by P(HIV|Contact and -PrEP) ")
p1_plot_5<-ggplot(var_p1,aes_string(x="p1",y=col_list[2]))+geom_point()+scale_y_continuous(limits=lims_var_p1)+xlab("P(HIV|Contact and -PrEP)")+ggtitle("Contrast estimate variance in random additional PrEP allocation by P(HIV|Contact and -PrEP) ")
p1_plot_6<-ggplot(var_p1,aes_string(x="p1",y=col_list[3]))+geom_point()+scale_y_continuous(limits=lims_var_p1)+xlab("P(HIV|Contact and -PrEP)")+ggtitle("Contrast estimate variance in random regenerated PrEP allocation by P(HIV|Contact and -PrEP) ")
ggsave(plot=p1_plot_5/p1_plot_4/p1_plot_6, file="p1 Variance plots.png", path="Figures/") 
```
...
p2_plot_1<-ggplot(means_p2,aes_string(x="p2",y=col_list[1]))+geom_point()+scale_y_continuous(limits=lims_means_p2)+xlab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random PrEP allocation by P(HIV|Contact and PrEP) ")
p2_plot_2<-ggplot(means_p2,aes_string(x="p2",y=col_list[2]))+geom_point()+scale_y_continuous(limits=lims_means_p2)+xlab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random additional PrEP allocation by P(HIV|Contact and PrEP) ")
p2_plot_3<-ggplot(means_p2,aes_string(x="p2",y=col_list[3]))+geom_point()+scale_y_continuous(limits=lims_means_p2)+xlab("P(HIV|Contact and PrEP)")+ggtitle("Mean contrast estimate in random regenerated PrEP allocation by P(HIV|Contact and PrEP) ")
```

```{r}
ggsave(plot=p2_plot_2/p2_plot_1/p2_plot_3,file="p2 Mean plots.png", path="Figures/")
```

Variance plots
```{r}
lims_var_p2<-c(min(var_p2[,col_list]),max(var_p2[,col_list]))
p2_plot_4<-ggplot(var_p2,aes_string(x="p2",y=col_list[1]))+geom_point()+scale_y_continuous(limits=lims_var_p2)+xlab("P(HIV|Contact and PrEP)")+ggtitle("Contrast estimate variance in random PrEP allocation by P(HIV|Contact and PrEP) ")
p2_plot_5<-ggplot(var_p2,aes_string(x="p2",y=col_list[2]))+geom_point()+scale_y_continuous(limits=lims_var_p2)+xlab("P(HIV|Contact and PrEP)")+ggtitle("Contrast estimate variance in random additional PrEP allocation by P(HIV|Contact and PrEP) ")
p2_plot_6<-ggplot(var_p2,aes_string(x="p2",y=col_list[3]))+geom_point()+scale_y_continuous(limits=lims_var_p2)+xlab("P(HIV|Contact and PrEP)")+ggtitle("Contrast estimate variance in random regenerated PrEP allocation by P(HIV|Contact and PrEP) ")
ggsave(plot=p2_plot_5/p2_plot_4/p2_plot_6, file="p2 Variance plots.png", path="Figures/") 
```
...
```{r}
params_model<-expand.grid(N=20,phiv=0.1,model=c("ER","BA"),PrEP1=PrEP1,PrEP2=PrEP2,p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1),nsim=200, stringsAsFactors = F)
...
model_plot_7+model_plot_8+model_plot_9+model_plot_10+model_plot_12+model_plot_13+model_plot_14+model_plot_15
```


```{r}
c("Number of Components g","Largest Component Size g", "Avg. Betweenness g","Density g","Degree Centralization g","Avg. Geodesic Distance g", "Diameter g", "Transitivity g","Proportion of nodes in 2-cores g", "Degree Assortativity g")
```


Change ER edge probability
```{r}
params_eprob<-expand.grid(N=20,eprob=seq(0.1,1,0.1),phiv=0.1,PrEP1=PrEP1,PrEP2=PrEP2,p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1),nsim=200)
...
eprob_plot_1<-ggplot(means_eprob,aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+scale_fill_gradientn(limits=lims_means_eprob,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~eprob)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_continuous(guide = guide_axis(n.dodge=2))
eprob_plot_2<-ggplot(means_eprob,aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+scale_fill_gradientn(limits=lims_means_eprob,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~eprob)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_continuous(guide = guide_axis(n.dodge=2))
eprob_plot_3<-ggplot(means_eprob,aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+scale_fill_gradientn(limits=lims_means_eprob,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~eprob)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_continuous(guide = guide_axis(n.dodge=2))
eprob_plot_2/eprob_plot_1/eprob_plot_3
```

Change BA preferential attachment power

```{r}
params_p<-expand.grid(N=50,phiv=0.1,PrEP1=0.2,PrEP2=0.4,p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1), model="BA",pow=seq(0.1,1,0.1), nsim=200,stringsAsFactors = F)
res_p<-future_pmap_dfr(params_p,sim_par)
means_p<-res_p%>%group_by(across(all_of(c("p","p1","p2"))))%>%summarise(across(col_list,mean))
var_p<-res_p%>%group_by(across(all_of(c("p","p1","p2"))))%>%summarise(across(col_list,var))
```

Means plots
```{r}
lims_means_p<-c(min(means_p[,col_list]),max(means_p[,col_list]))
p_plot_1<-ggplot(means_p,aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+scale_fill_gradientn(limits=lims_means_p,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~p)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_continuous(guide = guide_axis(n.dodge=2))
p_plot_2<-ggplot(means_p,aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+scale_fill_gradientn(limits=lims_means_p,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~p)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_continuous(guide = guide_axis(n.dodge=2))
p_plot_3<-ggplot(means_p,aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+scale_fill_gradientn(limits=lims_means_p,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~p)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_continuous(guide = guide_axis(n.dodge=2))
p_plot_2/p_plot_1/p_plot_3
```
...
```{r}
#check sample size
params_nb<-expand.grid(N=N,phiv=phiv,PrEP1=PrEP1,PrEP2=PrEP2, p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1), scale="additive",model="SW",eprob=eprob,pow=pow,nb=seq(5,N/2,5),rprob=rprob,stringsAsFactors = F)
...
nb_plot_1<-ggplot(means_nb,aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+scale_fill_gradientn(limits=lims_means_nb,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~nb)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_discrete(guide = guide_axis(n.dodge=2))
nb_plot_2<-ggplot(means_nb,aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+scale_fill_gradientn(limits=lims_means_nb,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~nb)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_discrete(guide = guide_axis(n.dodge=2))
nb_plot_3<-ggplot(means_nb,aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+scale_fill_gradientn(limits=lims_means_nb,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~nb)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_discrete(guide = guide_axis(n.dodge=2))
nb_plot_2/nb_plot_1/nb_plot_3
...
nb_plot_4<-ggplot(var_nb,aes_string(x="p1",y="p2",fill=col_list[1]))+geom_tile()+scale_fill_gradientn(limits=lims_var_nb,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~nb)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_discrete(guide = guide_axis(n.dodge=2))
nb_plot_5<-ggplot(var_nb,aes_string(x="p1",y="p2",fill=col_list[2]))+geom_tile()+scale_fill_gradientn(limits=lims_var_nb,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~nb)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_discrete(guide = guide_axis(n.dodge=2))
nb_plot_6<-ggplot(var_nb,aes_string(x="p1",y="p2",fill=col_list[3]))+geom_tile()+scale_fill_gradientn(limits=lims_var_nb,colors=brewer.pal(10,name="RdYlBu"))+facet_grid(~nb)+xlab("P(HIV|Contact and -PrEP)")+ylab("P(HIV|Contact and PrEP)")+scale_x_discrete(guide = guide_axis(n.dodge=2))
```
...
```{r}
params_rprob<-expand.grid(N=N,phiv=phiv,PrEP1=PrEP1,PrEP2=PrEP2, p1=seq(0.1,1,0.1),p2=seq(0.1,1,0.1), scale="additive",model="SW",eprob=eprob,pow=pow,nb=nb,rprob=seq(0.05,1,0.05),stringsAsFactors = F)
