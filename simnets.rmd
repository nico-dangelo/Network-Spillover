...
phiv<-0.5 # underlying hiv prevalence
...
if(plots==T){plot(g, vertex.size=10,vertex.label.cex=1, vertex.label.dist=2,main="Control")}
...
l_PrEP2_h<-ceiling(((gorder(g)-l_hiv_h)*PrEP2))
...
l_PrEP2_j<-ceiling(((gorder(g)-l_hiv_j)*PrEP2))
...
l_PrEP2_k<-ceiling(((gorder(k)-l_hiv_k)*PrEP2))
...
```{r}
N_plot1<-ggplot(means_N,aes_string(x="p1",y="p2", fill=col_list[1]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(colors=brewer.pal(5,name="RdYlBu"))
N_plot2<-ggplot(means_N,aes_string(x="p1",y="p2", fill=col_list[2]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(colors=brewer.pal(5,name="RdYlBu"))
N_plot3<-ggplot(means_N,aes_string(x="p1",y="p2", fill=col_list[3]))+geom_tile()+facet_grid(~N)+scale_fill_gradientn(colors=brewer.pal(5,name="RdYlBu"))
