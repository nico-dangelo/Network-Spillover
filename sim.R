library(igraph)
sim<-function(N=20,eprob=0.1,phiv=0.1,PrEP1=0.1,PrEP2=0.2, p1=0.2,p2=0.1, plots=F){
...
if(plots){plot(g, vertex.size=10,vertex.label.cex=1, vertex.label.dist=2)}
...
if(plots){plot(h,  vertex.size=10,vertex.label.cex=1, vertex.label.dist=2)}
...
if(plots){plot(j,  vertex.size=10,vertex.label.cex=1, vertex.label.dist=2)}
